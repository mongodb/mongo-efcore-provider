...
- For this area, the `[external-action]` deferral especially includes encryption paths needing `CRYPT_SHARED_LIB_PATH` (unset ⇒ `SupportsEncryption` is false and the tests skip).
