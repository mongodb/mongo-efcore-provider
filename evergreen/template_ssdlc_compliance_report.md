...
<table>
  <tr>
    <th>Product name</th>
    <td><a href="https://github.com/mongodb/mongo-efcore-provider">${PRODUCT_NAME}</a></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <th>Evergreen</th>
    <td>
        See the "Submitted by" field in <a href="https://spruce.mongodb.com/version/mongo-efcore-provider_v${PACKAGE_VERSION}_${github_commit}">Evergreen release patch</a>.
    </td>
  </tr>
   <tr>
    <th>Papertrail</th>
...
is <https://github.com/mongodb/mongo-efcore-provider/blob/v${PACKAGE_VERSION}/sbom.json>.
...
Blocked on <https://jira.mongodb.org/browse/EF-121>.
