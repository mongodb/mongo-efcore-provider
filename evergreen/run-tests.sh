...
dotnet test "./MongoDB.EFCoreProvider.sln" -e MONGODB__URI="${MONGODB_URI}" --results-directory ./build/test-results --logger "junit;verbosity=detailed;LogFileName=TEST_{assembly}.xml;FailureBodyFormat=Verbose"
