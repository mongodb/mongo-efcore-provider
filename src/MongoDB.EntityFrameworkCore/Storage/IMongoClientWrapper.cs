...
public interface IMongoClientWrapper
{
    ...
    /// <returns><see langref="true" /> if the database was created from scratch, <see langref="false" /> if it already existed.</returns>
    ...
    /// <see langref="true" /> if the database was created from scratch, <see langref="false" /> if it already existed.
    /// </returns>
    ...
    /// </summary>
    /// <returns><see langref="true" /> if the database was deleted, <see langref="false" /> if it did not exist.</returns>
    ...
    /// <returns>
    /// A <see cref="Task"/> that, when resolved, will be
    /// <see langref="true" /> if the database was deleted, <see langref="false" /> if it already existed.
    /// </returns>
    ...
    /// </summary>
    /// <returns><see langref="true" /> if the database exists, <see langref="false" /> if it does not.</returns>
    ...
    /// <returns>
    /// A <see cref="Task"/> that, when resolved, will be
    /// <see langref="true" /> if the database exists, <see langref="false" /> if it does not.
    /// </returns>
