...
public class MongoTransactionEnlistmentManager : ITransactionEnlistmentManager
{
    ...
    public void EnlistTransaction(Transaction? transaction)
        => throw new NotSupportedException(
            "The MongoDB EF Provider does not ambient transactions. Consider explicit (Database.BeginTransaction) or implicit (DbContext.SaveChanges) transactions instead.");
