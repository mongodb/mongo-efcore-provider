...
public static class MongoQueryableExtensions
{
    ...
    /// <summary>
    /// Adds an MongoDB Vector Search to this LINQ query. This method must be called at the root of an EF query
    ...
    /// <summary>
    /// Adds an MongoDB MongoDB Vector Search to this LINQ query. This method must be called at the root of an EF Core query
    /// against MongoDB, except that a <see cref="System.Linq.Queryable.Where{T}(IQueryable{T},Expression{Func{T,bool}})"/>
    /// clause can be used to add a pre-query filter.
    /// </summary>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
