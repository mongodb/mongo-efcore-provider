...
/// <summary>
/// MongoDB Vector Search index options.
...
/// <param name="Dimensions">Number of vector dimensions that MongoDB Vector Search enforces at index-time and query-time.</param>
...
{
    /// <summary>
    /// Creates an uninitialized MongoDB Vector Search index options object.
    /// </summary>
