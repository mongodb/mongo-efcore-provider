...
/// <summary>
/// Recognized <see cref="BsonDictionaryOptionsAttribute"/> applied to properties of an entity
...
public sealed class BsonDictionaryOptionsAttributeConvention(ProviderConventionSetBuilderDependencies dependencies)
    : NotSupportedPropertyAttributeConvention<BsonDictionaryOptionsAttribute>(dependencies);
