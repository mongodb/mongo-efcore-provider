...
/// </remarks>
public class HtmlStripFilterDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    /// The list of HTML tags to exclude from filtering.
    /// </summary>
    public IReadOnlyList<string>? IgnoredTags { get; set; }
    ...
    public override BsonValue ToBson()
    {
        ...
        if (IgnoredTags != null)
        {
            document.Add("ignoredTags", new BsonArray(IgnoredTags));
        }
        return document;
    }
}
