...
/// </remarks>
public class SearchIndexNumberDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    ...
    /// </summary>
    public bool? IndexIntegers { get; set; }
    ...
    public override BsonValue ToBson()
    {
        ...
        document.Add("representation", Representation?.ToString().ToLowerInvariant(), Representation != null);
        document.Add("indexIntegers", IndexIntegers, IndexIntegers != null);
        document.Add("indexDoubles", IndexDoubles, IndexDoubles != null);
        return document;
    }
}
