...
/// <summary>
/// Definition for the token filters with <see cref="Min"/> and <see cref="Max"/>.
/// </summary>
/// <remarks>
...
/// </remarks>
public class MinMaxFilterDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    ...
    /// <summary>
    /// String to append to "min" and "max" for the this filter.
    /// </summary>
    ...
    public override BsonValue ToBson()
    {
        ...
        document.Add("min" + Postfix, Min, Min != null);
        document.Add("max" + Postfix, Max, Max != null);
        return document;
    }
}
