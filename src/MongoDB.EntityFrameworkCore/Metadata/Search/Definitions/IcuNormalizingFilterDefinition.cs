...
/// </remarks>
public class IcuNormalizingFilterDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    /// The normalization form to apply, as defined by <see cref="IcuNormalizationForm"/>.
    /// </summary>
    public IcuNormalizationForm? NormalizationForm { get; set; }
    ...
    public override BsonValue ToBson()
    {
        ...
        {
            document.Add("normalizationForm", NormalizationForm.Value.ToString().ToLowerInvariant());
        }
        return document;
    }
}
