...
/// </remarks>
public class SearchIndexTokenDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    ...
    {
        var document = new BsonDocument { { "type", "token" } };
        document.Add("normalizer", NormalizeToLowercase == true ? "lowercase" : "none", NormalizeToLowercase != null);
        return document;
    }
}
