...
/// </remarks>
public class SearchIndexSynonymDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    /// The name of a well-known or custom analyzer.
    /// </summary>
    public string AnalyzerName { get; set; } = null!;
    ...
    public override BsonValue ToBson()
        => new BsonDocument
        {
            ...
            { "source", new BsonDocument { ["collection"] = CollectionName } }
        };
}
