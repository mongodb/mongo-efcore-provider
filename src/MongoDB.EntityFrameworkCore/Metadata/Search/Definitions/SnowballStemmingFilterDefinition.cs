...
/// </remarks>
public class SnowballStemmingFilterDefinition : SearchIndexDefinitionBase
{
    /// <summary>
    /// The stemmer to use, as defined by <see cref="SnowballStemmerName"/>.
    /// </summary>
    public SnowballStemmerName StemmerName { get; set; }

    /// <inheritdoc/>
    public override BsonValue ToBson()
    {
        var document = new BsonDocument { { "type", Name },  { "stemmerName", StemmerName.ToString().ToLowerInvariant() }  };
        return document;
    }
}
