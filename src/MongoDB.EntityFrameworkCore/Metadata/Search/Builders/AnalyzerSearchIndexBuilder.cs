...
public class AnalyzerSearchIndexBuilder(SearchIndexDefinition indexDefinition, string analyzerName)
{
    ...
    /// It produces tokens that start at the beginning of the term and extend up to the configured <see cref="maxGram"/>.
    ...
    /// term (infix grams). Produces overlapping tokens of length between <see cref="minGram"/> and <see cref="maxGram"/>,
