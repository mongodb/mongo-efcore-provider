...
// Originally EF Core ProjectionBindingExpression.cs
...
{
    /// <summary>
    ///     Creates a new instance of the <see cref="MongoProjectionBindingExpression" /> class.
    /// </summary>
    ...
    public MongoProjectionBindingExpression(
        Expression queryExpression,
        MongoProjectionMember projectionMember,
        Type type)
    {
    ...
    /// <param name="expressionType">The clr type of value being read.</param>
    /// <param name="projectionType">The clr type of value being read.</param>
    public MongoProjectionBindingExpression(
        Expression queryExpression,
        int index,
        Type expressionType,
    ...
    {
        expressionPrinter.Append(nameof(MongoProjectionBindingExpression) + ": ");
    ...
    public override bool Equals(object? obj)
        => obj != null
            && (ReferenceEquals(this, obj)
                || obj is MongoProjectionBindingExpression projectionBindingExpression
                && Equals(projectionBindingExpression));

    private bool Equals(MongoProjectionBindingExpression projectionBindingExpression)
